...
&Scoped-define FIELDS-IN-QUERY-BraamatuRaport traamaturaport.pealkiri traamaturaport.pealkiri traamaturaport.kasutaja traamaturaport.arv traamaturaport.tahtaeg   
&Scoped-define ENABLED-FIELDS-IN-QUERY-BraamatuRaport   
&Scoped-define SELF-NAME BraamatuRaport
&Scoped-define OPEN-QUERY-BraamatuRaport clLaenutus:GetRaportVolglased(INPUT-OUTPUT TABLE traamaturaport). OPEN QUERY {&SELF-NAME} FOR EACH traamaturaport NO-LOCK BY traamaturaport.pealkiri INDEXED-REPOSITION .
...
&Scoped-Define ENABLED-OBJECTS BraamatuRaport BtnExit 
...
traamaturaport.pealkiri FORMAT "x(20)":U           LABEL 'Pealkiri'
traamaturaport.kasutaja FORMAT "x(20)":U           LABEL 'Laenutaja'
traamaturaport.arv      FORMAT ">>9":U             LABEL 'Päevi üle tähtaja'
traamaturaport.tahtaeg  FORMAT "99/99/9999":U      LABEL 'Tähtaeg'
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 76 BY 25.48 FIT-LAST-COLUMN.
...
DEFINE FRAME FrmRaamatuRaport
     ...
     BtnExit AT ROW 28.14 COL 30.5 WIDGET-ID 2
...
/* Query rebuild information for BROWSE BraamatuRaport
     _START_FREEFORM
clLaenutus:GetRaportVolglased(INPUT-OUTPUT TABLE traamaturaport).
